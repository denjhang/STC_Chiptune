...
void ym2413_init(void) {
    ...
    ym_drum[0].wave = ym_sin;     ym_drum[0].step = 0x4A4D;  ym_drum[0].env_step = 160; ym_drum[0].vol = 8; /* BD */
    ...
    ym_drum[4].wave = ym_noise;   ym_drum[4].step = 0x1293;  ym_drum[4].env_step = 96;  ym_drum[4].vol = 8; /* SD noise 25Hz */
