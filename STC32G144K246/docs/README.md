...
4. **AY8910 + SN76489 + SCC(K051649) + NES APU + NES FDS + YM2413 + GB DMG 八音源** — 同 ISR 混音，开机音 C4/E4/G4 和弦 2 秒
5. **VGM 播放** — USB CDC 接收 AY(0xA0)/SN(0x50)/SCC(0xD2)/NES(0xB4)/NES-DMC(0xB6)/GB(0xB3)/YM2413(0x51)/Reset(0xF0) 命令，vgm_player.py 通过 COM24 播放
...
12. **Yamaha YM2413 (OPLL) FM 合成** — 9 通道 2-operator FM, 极简核心 (参考 STC32G12K128 fm.c): 64 点 s8 波形 + 线性相位调制 + ADSR 查表. 寄存器完整兼容 YM2413, 音色大体接近
