/* gb.c - Game Boy DMG 仿真核心 (STC32G C251 版)
...
static const u16 gb_noise_div[8] = { 8, 16, 32, 48, 64, 80, 96, 112 };
...
static GB_SND gb_ch[4];
static u8  gb_regs[0x30];
static u8  gb_ctrl_on;
static u8  gb_vol_l, gb_vol_r;
static u8  gb_ch_l[4], gb_ch_r[4];
static u32 gb_frame_cycles;
static u32 gb_base_count;
static u8  gb_frame_step;
